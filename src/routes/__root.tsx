...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "קורס מאפרת מקצועית" },
      { property: "og:description", content: "הפכי את הפיקדון הצבאי למקצוע. שכר יומי 800-2,000 ₪." },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Heebo:wght@400;600;700;800;900&family=Assistant:wght@300;400;500;600;700&family=Playfair+Display:wght@700;900&display=swap" },
    ],
  }),
